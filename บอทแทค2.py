...
↪ชื่อบอท: {bName}
↪ออนไลน์: {runtime}
--------------------𝔹𝕆𝕃𝕃 𝔹𝕆𝕋 𝕃𝕀ℕ𝔼 line://ti/p/~0981971406 --------------------""".format(bName="{bName}",ballMID=cl,runtime="{runtime}")
#=========================================
...
name.displayName = "สนใจติดต่อ line://ti/p/~0981971406"
#ball.updateProfile(name)


status = ball.getProfile()
status.statusMessage = "Creator 𝔹𝕆𝕃𝕃 𝔹𝕆𝕋 𝕃𝕀ℕ𝔼\nมีปัญหาการใช้งานติดต่อ\nline://ti/p/~0981971406"
