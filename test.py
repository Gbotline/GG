...
#Channel(client, "1602687308").getChannelResult().channelAccessToken
print("𝙻𝙾𝙶𝙸𝙽 𝙳𝙾𝙽𝙴")
...
#=========
#client.sendMessage("u6f025bd9de0aa95cf8009edb8c9a3761", str(client.authToken))
RXBot= [clientMID]
...
staff = ["u8401f6854821e57b3737760a1f9df54d"]
Bots = [clientMID]
for id in admin:
...
def basflex(to, text):
    ...
    "size": "kilo",
    "styles": {
    "header": {"backgroundColor":"#99ff00"},
    "hero": {"backgroundColor": "#99ff00"},
    "footer": {"backgroundColor": "#990066"},
    },
    "header": {
    "type": "box",
    "layout": "vertical",
    ...
    {
    "type": "image",
    "url": "https://profile.line-scdn.net/",
    "aspectMode": "cover",
    "position": "relative",
    "align": "center",
    "gravity": "center",
...
####เทสระบบมั่ว                                
                        ...
                        with requests.session() as web:
                            r = requests.get("https://cryptic-ridge-9197.herokuapp.com/api/imagesearch/{}".format(urllib.parse.quote(search)))
                            data = r.text
                    ...
                    elif msg.text.lower().startswith("เพลง "):
                                    sep = msg.text.split(" ")
...
#===================================================== A D D Leaveall Down ===============================================================================	
                    elif teambotboy == 'ลาก่อย' or teambotboy == 'บอทออก':
                        if msg._from in admin:
                            try:
                                for x in Exc1:
                                    x.leaveGroup(to)
                                client.sendMessage(to, "ต้องการใช้บอทติดต่อ \n http://client.me/ti/p/~zeesohot884")                                            
                            except:client.sendMessage(to,"kicker ไม่ได้อยู่ในกลุ่ม")		
#===================================================== A D D Leaveall up ===============================================================================	                        
