...
ball = LINE('afr74769@jiooq.com','golf06032543',appName="DESKTOPMAC\t6.5.2\tMAC\t10.15.1")
print("𝙻𝙾𝙶𝙸𝙽 𝙳𝙾𝙽𝙴")
...
user1 = ballMID
user2 = "u043d36cb5db2298595407d06e6405502"
msg_dict1 = {}
mulai = time.time()
Start = time.time()

name = ball.getProfile()
name.displayName = "สนใจติดต่อ "
#ball.updateProfile(name)


status = ball.getProfile()
status.statusMessage = "Creator GG 𝔹𝕆𝕋 𝕃𝕀ℕ𝔼\nมีปัญหาการใช้งานติดต่อ"
...
║↪.hilo (ไฮโล)
║↪.roulette (รูเล็ตต์)
╚═〘 𝔹𝕆𝕃𝕃 𝔹𝕆𝕋 𝕃𝕀ℕ𝔼 line://ti/p/~0981971406〙
"""
      return helpMessage3
...
#                                    print(msg)
                      ...
                      if msg._from in admin:
                            ...
                            runrespon.start()
                    elif msg.text.lower().startswith("ยี่กี:"):
                   #   if msg._from in admin:
                                    bctxt = msg.text[len("ยี่กี:"):].strip()
