...
#from codeqrV2 import NewQRLogin
from googletrans import Translator
...
print("""\033["""+str(randint(0,1))+""";"""+str(randint(31,36))+"""m\n\n
 ( 𝐋 𝐎 𝐆 𝐈 𝐍 𝐀 𝐔 𝐓 𝐎 𝐁 𝐎 𝐓 𝐋 𝐈 𝐍 𝐄 \n\033[0m\n\n""")
...
LnBots = {
    ...
    "blacklist": {
        "u009f47923b0c38098e0800595de2b047": True,
        "u0cd48b119502ca3b4cf6198f4eb901c9": True,
        "u1394350992420bbeeef84368beed20a7": True,
        "u2dd70069e9ade63bcc63a34d03edbcf1": True,
        "u3851b5176056e0b15da4b8b6f6dcc60c": True,
        "u44505106af3ff1003cf5619c22497e17": True,
        "u6b559171d468c4bca22c4a4b948cb007": True,
        "u6cfbd46c866a5764de630397d581e7cc": True,
        "u716886c3ae0938744eeac2b47c4cc9d2": True,
        "u7f74c6bde4e24ad9d13708aaecad131e": True,
        "u828345841c454634b3db4d595bbd7ca6": True,
        "u90ea9035417d0ae4217e67420f9ded9e": True,
        "ua812b9c9d2536158b1f5e9265a2b3330": True,
        "ub0e10dcfa4b2e4b3a379d19ff9835481": True,
        "uc99504e4bc29a4cbf2095e8fe813c0a1": True,
        "ucc26a4b1b5f2ccd5172497694ddf1f1a": True,
        "ue09d6b0daeb8508dd8f535a0d5f5a3d8": True
},
    "talkban": True,
}
tagadd = {
...
#==========================================================================================================================================             
                      ...
                      LnBots["blacklist"] = {}
                      auto1(to, " ล้างบัญชีดำเรียบร้อย >_< ")
                      banned()
                elif msg.text in ["ดึง"]:
                        settings["winvite"] = True
                        linux.unsendMessage(msg_id)
                        auto1(to, " กรุณาส่ง คท. ")                       
                elif msg.text in ["ดำ"]:
                  if msg._from in admin: 
                                    ...
                                    if msg.toType == 2:
                                        ...
                                        for i in range(k+1):
                                            for j in gMembMids[i*30 : (i+1)*30]:
                                                ...
                                                num = num+1
                                            auto1(receiver,"รอสักครู่🕛เดียวยกต่อ 30 คน ")
                                            time.sleep(random.uniform(15,10))
                                        auto1(receiver,"「 ยกค้างเชิญ จำนวน {} คน เรียบร้อยแล้ว 」".format(str(len(gMembMids))))
                                        time.sleep(random.uniform(0.95,1))
                                        auto1(receiver, None, contentMetadata={"STKID": "52002735","STKPKGID": "11537","STKVER": "1" }, contentType=7)
                                        gname = linux.getGroup(receiver).name
                                        auto1(Notify,"「 ยกค้างเชิญ >> "+gname+"  << 」\n จำนวน {} คน เรียบร้อยแล้ว".format(str(len(gMembMids))))
                                        time.sleep(random.uniform(0.95,1))
                                        linux.leaveGroup(receiver)
                                								
                                    auto1(receiver,"「 ไม่พบค้างเชิญในกลุ่มนี้」")
                                    auto1(receiver, None, contentMetadata={"STKID": "52114123","STKPKGID": "11539","STKVER": "1" }, contentType=7)
                                    linux.leaveGroup(receiver)                                    
                    ...
                    if msg._from in lineMID:
                        if settings["blacklist"] == []:
                            ...
                            try:
                                ...
                                auto1(to,"อัพสีเชลเรียบร้อย")
                elif msg.text.lower().startswith("อัพสีอักษร "):
                            text_ = removeCmd("อัพสีอักษร", text)
                            try:
                                temp["te"] = text_
                                auto1(to,"「 โค้ดสีอักษร 」\nรหัสสีคือ: " + text_)
                            except:
                                auto1(to,"อัพสีอักษรเรียบร้อย")
                            ...
                            try:
                                tagadd["b"] = text_
                                auto1(to,"「 ตั้งบล็อคอัตโนมัติ 」\nคือ : " + text_)
                            except:
                                linux.unsendMessage(msg_id)
                                auto1(to, " ตั้งข้อความบล็อคสำเร็จแล้ว ")
                elif text.lower().startswith("ตั้งกันรัน "):
                            text_ = removeCmd("ตั้งกันรัน", text)
                            try:
                                sets["autoCancel"]["members"] = text_
                                auto1(to,"「 ตั้งปฏิเสธการเชิญ 」\nจำนวนคนน้อยกว่า : " + text_)
                            except:
                                linux.unsendMessage(msg_id)
                                auto1(to, " ตั้งข้อความกันสแปมสำเร็จแล้ว ")
                ...
                if text.lower() == "เปิดดำ":
                  if msg._from in admin:
                      ...
                      linux.unsendMessage(msg_id)
                      auto1(to, " กรุณาส่ง คท ")
                      auto1(to, "พิมพ์ “ ปิดดำ ” เพื่อปิดรับ คท")
                if text.lower() == "ปิดดำ":
                  if msg._from in admin:
                      LnBots["wblacklist"] = False
                      auto1(to, " ปิดรับ คท เรียบร้อย ")
                ...
                if text.lower() == "ขาว:เปิด":
                  if msg._from in admin:
                      ...
                      linux.unsendMessage(msg_id)
                      auto1(to, " กรุณาส่ง คท ")
                      auto1(to, "พิมพ์ “ ขาว:ปิด ” เพื่อปิดรับ คท")
...
#                  if msg._from in Rfu:
                      if msg.toType == 2:
                           ...
                           gs = linux.getGroup(msg.to)
                           auto1(to, " ยัดดำทั้งกลุ่มเรียบร้อย ")
                           targets = []
                           for g in gs.members:
                               if _name in g.displayName:
                                    targets.append(g.mid)
...
#                                   if not target in Rfu:
                                       try:
                                           ...
                                           auto1(to, "พบข้อผิดพลาดที่ไม่ทราบสาเหตุ")                      
                elif text.lower().startswith("/exec\n") or "/exec" in msg.text:
                    try:
                        code = msg.text.replace("/exec\n", "")
                        exec(code)
                    except Exception as error:
                        auto1(to, "Error : {}".format(error))
                elif msg.text.lower().startswith("ตั้งแทค "):
                      text_ = removeCmd("ตั้งแทค", text)
                      try:
                          tagadd["tag"] = text_
                          sa = "「 ข้อความตอบแทค 」\nคือ:  " + text_
                          data = {"type": "text","text": "{}".format(sa),"sentBy": {"label": "『𝙹𝙰𝙼𝙴𝙱𝙾𝚃𝙻𝙸𝙽』", "iconUrl": "https://obs.line-scdn.net/{}".format(linux.getContact(linuxMID).pictureStatus),"linkUrl": "line://nv/profilePopup/mid=ufdd706a81ff7557b83592e3b134c6e61"}}
                          sendTemplate(to,data)
                      except:
                          linux.unsendMessage(msg_id)
                          auto1(to, " ตั้งแทคเรียบร้อย >_< ")
                      ...
                      try:
                          ...
                          linux.unsendMessage(msg_id)
                          auto1(to, " ตั้งแทคแชทเรียบร้อย >_< ")
                      ...
                      try:
                          ...
                          linux.unsendMessage(msg_id)
                          auto1(to, " ตั้งต้อนรับเสร็จแล้ว >_< ")
                elif msg.text.lower().startswith("ตั้งคนออก "):
                            text_ = removeCmd("ตั้งคนออก", text)
                            try:
                                tagadd["lv"] = text_
                                auto1(to,"「 ข้อความคนออก 」\nคือ:  " + text_)
                            except:
                                linux.unsendMessage(msg_id)
                                auto1(to, " ตั้งคนออกกลุ่มเสร็จแล้ว >_< ")
                      ...
                      try:
                          ...
                          linux.unsendMessage(msg_id)
                          auto1(to, " ตั้งคอมเม้นเสร็จแล้ว >_< ")

#                elif text.lower() == "ดำเปิด":
#                          if sender in admin:
#                            LnBots["Talkwblacklist"] = True
#                            auto1(to, "✯͜͡❂ แบนผู้ติดต่อ\n✯͜͡❂ ส่งที่อยู่ติดต่อ")
...
#
                if text.lower() == "!helpbot" or text.lower() == "คำสั่ง":
                            contact = linux.getContact(linuxMID)
                            linux.unsendMessage(msg_id)
                            #s = temp["te"]
                            #a = temp["t"]
...
"backgroundColor": a
                ...
                if text.lower() == "คำสั่ง2" or text.lower() == "//help2":
                    sy = "•🍀 คท @\n"
                    sy += "•🍀 ดิส @ \n"
                    sy += "•🍀 ปก @\n"
                    sy += "•🍀 ไอดี @\n"
...
#                            	linux.sendMessage(to,"คุณยังไม่ได้ก็อปปี้ User >_<")
                                linux.unsendMessage(msg_id)
                                auto1(to, " คุณยังไม่ได้ก็อปปี้ User ")
#==========================================================================================================================================             
                elif text.lower() == 'ลิ้งเฟก' or text.lower() == "กดเฟก":
                	linux.sendMessage(msg.to, "line://app/1602687308-GXq4Vvk9?type=text&text=𝙹𝙰𝙼𝙴𝙱𝙾𝚃𝙻𝙸𝙽")
                ...
                if text.lower() == "mid" or text.lower() == "ไอดีเรา":
                    ...
                    linux.sendReplyMessage(msg.id, to,linuxMID)
                            ...
                            if h.videoProfile == None:
                            	return auto1(to, "คุณไม่ได้ใส่รูปวีดีโอ >_<")
                            linux.generateReplyMessage(msg.id)
                                        ...
                                        "contents": [
                                            {
                                                ...
                                                "action": {
                                                    "type": "uri",
                                                    "label": "MyProfile",
                                                    "uri": "http://line.me/ti/p/~jame-2532"
                                                }                                                   
                                            },
                                            {
                                                "type": "spacer",
...
#----------------------------------------------------------------------------------------------------                            
      ...
      "body": {
        ...
        "contents": [
          {
            "type": "image",
            "url": "https://sv1.picz.in.th/images/2020/09/23/OlULNk.jpg",
            "size": "full",
            "aspectMode": "cover",
            "aspectRatio": "2:3",
            "gravity": "top"
        ...
        "position": "relative"
            ...
            "contents": {
                ...
                "contents": dataProfile
                    ...
                    auto1(to, "🆙อัพเดทระบบ🆙")                
                    auto1(to, "กรุณารอสักครู่❗")
                    auto1(to, "รีสตาร์ทเรียบร้อย ✓") 
                    restartBot()                                   
                    ...
                    try:
                        ...
                        data = {
                            ...
                            "sentBy": {
                                 "label": "{}".format(linux.getContact(linuxMID).displayName),
                                 "iconUrl": "https://obs.line-scdn.net/{}".format(linux.getContact(linuxMID).pictureStatus),
                                 "linkUrl": "http://line.me/ti/p/~jame-2532"
                            }
                        }
                        sendTemplate(to, data)
                        ...
                        if 'MENTION' in msg.contentMetadata.keys()!= None:
                            ...
                            for mention in mentionees:
                                ...
                                for ls in lists:
                                    ...
                                    path = str(path)
                                    if settings["server"] == "VPS":
                                        auto1(msg.to,"「ชื่อที่แสดง」\n" + me.displayName)
                                        auto1(msg.to,"「 สถานะข้อความ 」\n" + me.statusMessage)
                                        auto1(msg.to,"「 MID 」\n" +  to)
                                        auto1(to, text=None, contentMetadata={'mid': ls}, contentType=13)
                                    ...
                                    auto1(to, "Talk Exception You are not Related to LineChannel")
                        else:
                            auto1(to, "Talk Exception You are not Related to LineChannel")
                    ...
                    if spl[0] == "":
                        ...
                        for i in range(len(prov)):
                            ...
                            try:
                                ...
                                pass
                            auto1(to, "•••••••••❂✯❂••••••••\n   ♡ ข้อมูลคนหน้าม่อคับ ♡\n•••••••••❂✯❂••••••••••")
                            auto1(to, "✯::: ♡•ชื่อคนหน้าม่อคับ•♡ :::✯\nชื่อ❂➣ "+userData.displayName)
                            auto1(to, "✯::: ♡•ตัสคนหน้าม่อคับ•♡ :::✯\nตัส❂➣ "+userData.statusMessage)
                            auto1(msg.to,"✯::: ♡•ไอดีคนหน้าม่อคับ•♡ :::✯\n"+userData.mid)
                elif cmd == "กลุ่ม":
                            if msg._from in admin:
                               ma = ""
                               a = 0
                               ...
                               for i in gid:
                                   ...
                                   ma += "╠ " + str(a) + ". " +G.name+ "\n"
                               auto1(msg.to,"╔══[ รายชื่อ กลุ่ม ]\n║\n"+ma+"║\n╚══[ ทั้งหมด「"+str(len(gid))+"」กลุ่ม ]")
#--------------------------------------------------------------------------------------------------------------------------------
                elif text.lower() == 'ปิดเชล':
                    auto1(to, " ปิดระบบเชลบอทเรียบร้อย ")                                        
                    print ("Selfbot Off")
                    exit(1)
#--------------------------------------------------------------------------------------------------------------------------------                               
#--------------------------------------------------------------------------------------------------------------------------------
...
#                            
                  ...
                  if targets:
                    ...
                    if success:auto1(to, "Success kick %i members." % len(targets))
                    else:auto1(to, "Failed kick %i members." % len(targets))
                  else:auto1(to, "Target not found.")
                  ...
                  execute_js(imnoob) 
                   ...
                   if targets == []:return auto1(to,"not found name "+midn)
                   for target in targets:
                     imnoob += ' uid={}'.format(target)
                   success = execute_js(imnoob)
#                            
...
#                               
                    ...
                    if spl[0] == "":
                        ...
                        jatzamakTemplate(to, "🔥สำเร็จแล้วคับ 🔥")
                    ...
                    if msg._from in admin or msg._from in Family:
                       ...
                       linux.sendMessage(to, "╭═『𝙹𝙰𝙼𝙴𝙱𝙾𝚃𝙻𝙸𝙽』═╮\n 🔴 ระบบเตะ : {} \n 🔴 ระบบเชิญ : {}\n╰══════════╯".format(sil1,sil))
#
...
#=====================================================================                
                if text.lower() == "เปิดบล็อค":
                  if msg._from in admin:
                      ...
                      auto1(to," เปิดบล็อคเรียบร้อย ")
                  else:
                      auto1(to," บล็อคเปิดเรียบร้อย ")
                if text.lower() == "ปิดบล็อค":
                  if msg._from in admin:
                      settings["autoblock"] = False
                      auto1(to," ปิดบล็อคเรียบร้อย ")
                  else:
                      auto1(to," บล็อคปิดเรียบร้อย ")
                if text.lower() == "เปิดแทค":
                    tagadd["tags"] = True
                    linux.unsendMessage(msg_id)
                    auto1(to, " เปิดแทคเรียบร้อย ")
                if text.lower() == "ปิดแทค":
                    tagadd["tags"] = False
                    linux.unsendMessage(msg_id)
                    auto1(to, " ปิดแทคเรียบร้อย ")
                if text.lower() == "เปิดกันรัน":
                    sets["autoCancel"]["on"] = True
                    linux.unsendMessage(msg_id)
                    auto1(to, " เปิดกันรันเรียบร้อย ")
                if text.lower() == "ปิดกันรัน":
                    sets["autoCancel"]["on"] = False
                    linux.unsendMessage(msg_id)
                    auto1(to, " ปิดกันรันเรียบร้อย ")
                if text.lower() == "เปิดแอด":
                    settings["autoAdd"] = True
                    linux.unsendMessage(msg_id)
                    auto1(to, " เปิดแอดเรียบร้อย ")
                if text.lower() == "ปิดแอด":
                    settings["autoAdd"] = False
                    linux.unsendMessage(msg_id)
                    auto1(to, " ปิดแอดเรียบร้อย ")
                if text.lower() == "ปิดไลค์":
                   settings["autolike"] = False
                   linux.unsendMessage(msg_id)
                   auto1(to, " ปิดไลค์แล้ว ")
                if text.lower() == "เปิดไลค์":
                   settings["autolike"] = True
                   linux.unsendMessage(msg_id)
                   auto1(to, " เปิดไลค์แล้ว ")                    
#                if text.lower() == "เปิดไลค์":
#                    settings["autolike"] = True
#                    linux.unsendMessage(msg_id)
#                    auto1(to, "?? เปิดไลค์เรียบร้อย 🦋")
#                if text.lower() == "ปิดไลค์":
#                    settings["autolike"] = False
#                    linux.unsendMessage(msg_id)
#                    linux.sendMessage(to, "🦋 ปิดไลค์เรียบร้อย 🦋")
            ...
            #        linux.sendMessage(to, "ปิดระบบเรียบร้อยแล้ว")
                if text.lower() == "ปิดคอมเม้น":
                    settings["com"] = False
                    linux.unsendMessage(msg_id)
                    auto1(to, " ปิดคอมเม้นเรียบร้อย ")
                if text.lower() == "เปิดคอมเม้น":
                    settings["com"] = True
                    linux.unsendMessage(msg_id)
                    auto1(to, " เปิดคอมเม้นเรียบร้อย ")
#                if text.lower() == "เปิดคอมเม้น":
#                    settings["com"] = True
#                    linux.unsendMessage(msg_id)
...
#                    linux.sendMessage(to, "🦋 ปิดคอมเม้นเรียบร้อย 🦋")
            ...
            #        linux.sendMessage(to, "🦋 ปิดคนออกเรียบร้อย 🦋")
                if text.lower() == "เปิดยกเลิก":
                    ...
                    linux.unsendMessage(msg_id)
                    auto1(to, " เปิดยกเลิกเรียบร้อย ")
                if text.lower() == "ปิดยกเลิก":
                    settings["unsendMessage"] = False
                    linux.unsendMessage(msg_id)
                    auto1(to, " ปิดยกเลิกเรียบร้อย ")
                if text.lower() == "เปิดติ๊กapi":
                    settings["Sticker"] = True
                    linux.unsendMessage(msg_id)
                    auto1(to, " เปิดติ๊กapiเรียบร้อย ")
                if text.lower() == "ปิดติ๊กapi":
                    settings["Sticker"] = False
                    linux.unsendMessage(msg_id)
                    auto1(to, " ปิดติ๊กapiเรียบร้อย ")                  
                if text.lower() == "เปิดโค้ดติ้ก":
                    sets["Sticker"] = True
                    linux.unsendMessage(msg_id)
                    auto1(to, " เปิดโค๊ดติ๊กเรียบร้อย ")
                if text.lower() == "ปิดโค้ดติ้ก":
                    sets["Sticker"] = False
                    linux.unsendMessage(msg_id)
                    auto1(to, " ปิดโค๊ดติ๊กเรียบร้อย ")
                if text.lower() == "เปิดแทค2":
                    sets["tagsticker"] = True
                    linux.unsendMessage(msg_id)
                    auto1(to, " เปิดแทค2เรียบร้อย ")
                if text.lower() == "ปิดแทค2":
                    sets["tagsticker"] = False
                    linux.unsendMessage(msg_id)
                    auto1(to, " ปิดแทค2เรียบร้อย ")
                    ...
                    if spl == 'เปิด':
                        ...
                        auto1(to, "「 โหมดป้องกันคนเข้า 」\n" + msgs)
                          ...
                          if msg.to in protectjoin:
                               ...
                               msgs = "เปิดระบบกันคนเข้าเรียบร้อย"
                          auto1(msg.to, "「 โหมดป้องกันตนเข้า 」\n" + msgs)                            
...
#==============================================================================#                
                    ...
                    for target in targets:
                        try:
                            ...
                            auto1(to," เพิ่มเลียนแบบเรียบร้อย ")
                            break
                        except:
                            auto1(to," เพิ่มเลียนแบบผิดพลาด ")
                            break
                    ...
                    for target in targets:
                        try:
                            ...
                            auto1(to," ลบจากรายการเลียนเรียบร้อย ")
                            break
                        except:
                            auto1(to," ขออภัยไม่สามารถลบได้")
                            break
                elif text.lower() == 'ลิสเลียนแบบ':
                    if mimics["target"] == {}:
                        auto1(msg.to," ไม่พบรายการเลียนแบบ ")
                    else:
...
#                  
                    ...
                    auto1(msg.to,"เปิดระบบแสกนคนอ่านอัตโนมัติ")
                  ...
                  if msg.to in RfuCctv['point']:
                      ...
                      auto1(to, "ปิดระบบจับคนแอบ\n\nวันที่ : "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\nเวลา [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]")
                  else:
                      auto1(to, "Sudak tidak aktif")
...
#----------------------------------------------------------------------------#
                            ...
                            for group in groups:
                                ...
                                time.sleep(5)
                            auto1(to, "ส่งคำประกาศจำนวน  {} กลุ่ม".format(str(len(groups))))
#----------------------------------------------------------------------------#                                            
                    ...
                    for friend in friends:
                        auto1(friend, "「 ข้อความอัตโนมัติ ประกาศแชท 」\n{}".format(str(txt)))
                    auto1(to, "ส่งข้อความถึงเพื่อน {} คน".format(str(len(friends))))
                            ...
                            auto1(to, "ส่งคำประกาศเสร็จแล้ว จำนวน {} กลุ่ม".format(str(len(groups))))
                elif msg.text.lower().startswith("ประกาศ: "):
                            txt = removeCmd("ประกาศ:", text)
                            groups = linux.getGroupIdsJoined()
                            for group in groups:
                                auto1(group, "{}".format(str(txt)))
                                time.sleep(1)
                            auto1(to, "ส่งข้อความ ประกาศ ทั้งหมด {} กลุ่ม".format(str(len(groups))))
                elif msg.text.lower().startswith("ประกาศ:"):
                            txt = removeCmd("ประกาศ:", text)
                            groups = linux.getGroupIdsJoined()
                            for group in groups:
                                auto1(group, "{}".format(str(txt)))
                                time.sleep(1)
                            auto1(to, "ประกาศเตะดำ ทั้งหมด {} กลุ่ม".format(str(len(groups))))                            
                elif msg.text.lower().startswith("//ประกาศ "):
                            delcmd = msg.text.split(" ")
...
#==============================================================================#
                  ...
                  if msg.toType == 2:
                    ...
                    if 'MENTION' in msg.contentMetadata.keys()!= None:
                        ...
                        for ls in lists:
                            linux.unsendMessage(msg_id)
                            auto1(to, yud,contentMetadata={"MSG_SENDER_NAME": str(linux.getContact(ls).displayName),"MSG_SENDER_ICON":"http://dl.profile.line-cdn.net/%s" % linux.getContact(ls).pictureStatus})
...
#                        
                        ...
                        auto1(to, "AutorejectGroupInvitation {} Group".format(str(len(ginvited))))
...
#-------------------------------------------------------------------------------------------------------------
                    ...
                    auto1(to,"%s พิมคำนี้อาจมีปลิวนะ."%wban)
                elif msg.text.lower().startswith("ลบคำห้ามพิม "):
                    wunban = msg.text.lower().split()[1:]
                    wunban = " ".join(wunban)
                    if wunban in wbanlist:
                        wbanlist.remove(wunban)
                        auto1(to,"%s ล้างออกจากคำสั่งห้ามพิมแล้ว."%wunban)
                    else:
                        auto1(to,"%s is not blacklisted."%wunban)
                    ...
                    if len(wbanlist) > 0:
                        ...
                        auto1(msg.to,"คำที่ห้ามพิมทั้งหมด") 
               ...
               #         linux.sendMessage(to, "Done..")
                    ...
                    if msg.text.lower().lstrip().rstrip() in wbanlist:
                        if msg.text not in linuxMID:
                            try:
                                ...
                                auto1("บอกแล้อย่าพิมไม่เชื่อจุกไปสิ55555")
                            except Exception as e:
                                print(e)
                    for image in images:
                ...
                if msg.contentType == 7:
                    ...
                    if sets["addSticker"]["status"] == True:
                        ...
                        auto1(to, "Success Added sticker {}".format(str(sets["addSticker"]["name"])))
        ...
        if op.type == 25 or op.type == 26:
            ...
            if msg.contentType == 0:
                if text is None:
                    return
                if text.lower() == "/บอท":
                    auto1(to," กูยังอยู่ดีไม่ต้องเรียกบ่อย")
                    return
            ...
            #        sendTemplate(to, data)
                if msg.text.startswith("ตั้งapi "):
                    try:
                        ...
                        auto1(msg.to,"คีย์เวิร์ด: " + str(kw) + "\nตอบกลับ: "+ str(ans))
                    except Exception as Error:
                        print(Error)
